...
void get_distance(const std::shared_ptr<example_interfaces::srv::AddTwoInts::Request> request,
...
int main(int argc, char const *argv[])
{
    ...
    server_ = node->create_service<example_interfaces::srv::AddTwoInts>("dist_two_point", &get_distance);
